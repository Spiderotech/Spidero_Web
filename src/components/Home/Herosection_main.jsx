      ...
      <div className="space-y-2 z-10 relative top-[60%] transform -translate-y-1/2">
        <div className="flex flex-col items-start">
          ...
          <div className="mt-5 ml-10 hidden md:flex">
            ...
            <a href="/contact">
              <button className="ml-10 w-[147px] h-[51px] font-sans leading-6 tracking-2px text-[16px] font-medium text-white bg-black transition-all ease-in-out hover:bg-white hover:text-black">
                CONTACT US
              </button>
            </a>
          </div>
