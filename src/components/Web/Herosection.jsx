...
const Herosection = () => {
  return (
    <section className="relative h-screen flex flex-col items-center justify-center text-center text-white py-0 px-3 ">
      ...
      <div className="absolute  md:top-32 top-10 sm:left-16 p-2 ">
        <div className="space-y-2 relative">
          <div className="flex flex-col items-start">
            <h2 className="text-white pt-8 text-start leading-10 font-sans font-bold t text-[18px] pb-5 ">
              WEB DEVELOPMENT
            </h2>
            <span className="font-sans text-[24px] md:text-[36px] font-semibold leading-7 tracking-normal text-start mb-3  pb-5 text-white  h-auto">
