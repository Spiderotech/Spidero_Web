...
const Companyabout_verticalscroll = () => {
  return (
    <section className="relative overflow-hidden bg-white px-5 py-14 sm:px-8 lg:px-12">
      ...
      <div className="pointer-events-none absolute bottom-10 right-0 h-80 w-80 rounded-full bg-blue-100/60 blur-3xl" />

      <div className="relative mx-auto grid max-w-7xl gap-9 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="lg:sticky lg:top-24">
          <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-blue-800">
          ...
          <h2 className="mt-5 max-w-xl text-3xl font-extrabold leading-tight tracking-normal text-[#07122f] sm:text-4xl lg:text-5xl">
            ...
            <span className="text-blue-800">Custom Software</span> Development Company?
          </h2>

          <div className="mt-5 h-1 w-20 rounded-full bg-gradient-to-br from-blue-800 to-blue-800" />
          ...
          <div className="mt-8 grid max-w-lg grid-cols-3 gap-3">
            {[
              ...
              >
                <div className="text-xl font-extrabold tracking-normal text-blue-800">{value}</div>
                <div className="mt-1 text-xs font-semibold tracking-normal text-slate-600">{label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="space-y-4">
            {cards.map(({ title, icon: Icon, text, accent }, index) => (
              <article
                key={title}
                className="relative rounded-3xl border border-slate-200/80 bg-white p-5 shadow-[0_18px_52px_rgba(15,23,42,0.07)] sm:p-6"
              >
                <div className="flex gap-4">
                  <div className="relative z-10 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-slate-50 shadow-inner">
                    ...
                    <Icon className="relative h-7 w-7 text-blue-800" />
                  </div>

                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <div className="text-xs font-bold uppercase tracking-[0.14em] text-blue-800">
                      ...
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-800 transition group-hover:bg-blue-800 group-hover:text-white">
