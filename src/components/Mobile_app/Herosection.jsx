...
const Herosection = () => {
  return (
    ...
    <div className="flex flex-row w-full h-auto items-center justify-center text-center mt-40  mb-10  ">
      ...
      <div className="w-[50%] h-auto ">
        ...
        <div className="space-y-2 relative ">
          <div className="flex flex-col items-start  lg:w-[60%] ">
            <h2 className="text-black lg:pt-8 text-start leading-10 font-sans font-bold text-xl md:text-3xl lg:text-4xl ">
            MOBILE APP DEVELOPMENT
            </h2>
            <p className="font-sans text-[18px] leading-7 font-medium tracking-normal text-start mb-3 p-3 text-black hidden sm:flex  ">
