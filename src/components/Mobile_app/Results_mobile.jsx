...
const themes = {
  red: {
    accent: "text-red-500",
    activeTab:
      "border-red-500/60 bg-red-600 text-white shadow-[0_18px_42px_rgba(239,35,42,0.26)]",
    glow:
      "bg-[radial-gradient(circle_at_center,rgba(239,35,42,0.14),transparent_58%)]",
    sideGlow:
      "bg-[radial-gradient(circle_at_center,rgba(239,35,42,0.1),transparent_60%)]",
    line: "bg-red-500",
    border: "border-red-500",
    hoverBorder: "hover:border-red-500",
    softBorder: "border-red-500/35",
    panel: "border-red-500/35 bg-red-950/10",
    cover: "from-red-500 to-red-800 shadow-[0_28px_70px_rgba(239,35,42,0.32)]",
    coverIcon: "text-red-300/70",
    cta: "border-red-500 hover:bg-red-600",
    performanceBorder: "xl:border-red-500/45",
  },
  green: {
    accent: "text-lime-400",
    activeTab:
      "border-lime-400/60 bg-lime-500 text-black shadow-[0_18px_42px_rgba(132,204,22,0.24)]",
    glow:
      "bg-[radial-gradient(circle_at_center,rgba(132,204,22,0.13),transparent_58%)]",
    sideGlow:
      "bg-[radial-gradient(circle_at_center,rgba(34,197,94,0.12),transparent_60%)]",
    line: "bg-lime-400",
    border: "border-lime-400",
    hoverBorder: "hover:border-lime-400",
    softBorder: "border-lime-400/35",
    panel: "border-lime-400/35 bg-lime-950/10",
    cover: "from-lime-400 to-emerald-800 shadow-[0_28px_70px_rgba(132,204,22,0.25)]",
    coverIcon: "text-lime-100/75",
    cta: "border-lime-400 hover:bg-lime-500 hover:text-black",
    performanceBorder: "xl:border-lime-400/45",
  },
  blue: {
    accent: "text-sky-400",
    activeTab:
    ...
    softBorder: "border-sky-400/35",
    panel: "border-sky-400/35 bg-sky-950/10",
    cover: "from-sky-400 to-blue-900 shadow-[0_28px_70px_rgba(14,165,233,0.25)]",
    coverIcon: "text-sky-100/75",
    cta: "border-sky-400 hover:bg-sky-500",
    performanceBorder: "xl:border-sky-400/45",
  },
  teal: {
    accent: "text-teal-400",
    activeTab:
      "border-teal-400/60 bg-teal-500 text-black shadow-[0_18px_42px_rgba(20,184,166,0.24)]",
    glow:
    ...
    softBorder: "border-teal-400/35",
    panel: "border-teal-400/35 bg-teal-950/10",
    cover: "from-teal-400 to-emerald-900 shadow-[0_28px_70px_rgba(20,184,166,0.25)]",
    coverIcon: "text-teal-100/75",
    cta: "border-teal-400 hover:bg-teal-500 hover:text-black",
    performanceBorder: "xl:border-teal-400/45",
  },
};
