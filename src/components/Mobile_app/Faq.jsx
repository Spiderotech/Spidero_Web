...
const accentStyles = {
  ...
  violet: {
    ...
    shadow: "shadow-[0_18px_60px_rgba(124,58,237,0.12)]",
  },
  purple: {
    number: "text-purple-600 bg-purple-50",
    icon: "text-purple-600 bg-purple-50",
    border: "border-purple-500",
    shadow: "shadow-[0_18px_60px_rgba(147,51,234,0.12)]",
  },
  pink: {
    number: "text-pink-600 bg-pink-50",
    icon: "text-pink-600 bg-pink-50",
    border: "border-pink-500",
    shadow: "shadow-[0_18px_60px_rgba(219,39,119,0.12)]",
  },
  teal: {
    number: "text-teal-600 bg-teal-50",
    icon: "text-teal-600 bg-teal-50",
    border: "border-teal-500",
    shadow: "shadow-[0_18px_60px_rgba(13,148,136,0.12)]",
  },
};
...
const Faq = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-white px-5 py-10 font-sans sm:px-8 lg:px-10 lg:py-12">
      ...
      <div className="pointer-events-none absolute right-0 top-0 h-72 w-72 rounded-full bg-violet-100/60 blur-3xl" />
      <div className="pointer-events-none absolute left-0 bottom-0 h-72 w-72 rounded-full bg-blue-100/55 blur-3xl" />

      <div className="relative mx-auto max-w-[1080px]">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-1.5 text-xs font-extrabold uppercase tracking-[0.14em] text-blue-600">
          ...
          <h2 className="mt-4 text-3xl font-extrabold leading-tight tracking-normal text-[#07122f] sm:text-4xl lg:text-[46px]">
            Best practices{" "}
            <span className="text-indigo-500">that we follow</span>
          </h2>

          <p className="mx-auto mt-3 max-w-2xl text-sm font-medium leading-6 tracking-normal text-slate-500 sm:text-base">
              ...
              >
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {isExpanded && (
                      <span className="mt-1.5 block max-w-2xl text-sm font-medium leading-5 tracking-normal text-slate-500">
                        {summary}
                      </span>
                    )}
                  </span>
                    ...
                    <div className="grid overflow-hidden rounded-xl border border-slate-200 bg-white/80 sm:grid-cols-2 lg:grid-cols-4">
                      {benefits.map(({ title: benefitTitle, text, icon: BenefitIcon }, benefitIndex) => (
                        ...
                        >
                          ...
                          <p className="mt-1.5 text-xs font-medium leading-5 tracking-normal text-slate-500">
                            {text}
                          </p>
                        </div>
                      ))}
