    ...
    <section className="overflow-hidden bg-white px-5 py-10 font-sans sm:px-8 lg:px-10 lg:py-12">
      <div className="mx-auto grid max-w-[1180px] items-center gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(390px,1.15fr)] xl:gap-10">
        <div className="min-w-0">
          <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-blue-800">
            Our Philosophy
          </p>
          <div className="mt-4 h-0.5 w-16 rounded-full bg-gradient-to-br from-blue-800 to-blue-800" />

          <h2 className="mt-6 max-w-[520px] text-3xl font-extrabold leading-tight tracking-normal text-[#07122f] sm:text-4xl lg:text-[48px]">
            Messages That Mean{" "}
            <span className="text-blue-800">Something</span>
          </h2>
          ...
          <div className="mt-7 grid gap-4 sm:grid-cols-3">
            {values.map(({ title, text, icon: Icon }, index) => (
              ...
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 text-blue-800">
        ...
        <div className="relative min-h-[380px] overflow-hidden rounded-[28px] bg-blue-50 shadow-[0_22px_60px_rgba(30,64,175,0.09)] sm:min-h-[500px] lg:min-h-[560px]">
          ...
          <div className="absolute inset-8 rounded-[24px] bg-blue-100/70" />
          <div className="absolute left-1/2 top-1/2 w-[72%] -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-8 shadow-[0_22px_60px_rgba(30,64,175,0.11)] sm:p-10">
            <div className="text-[68px] font-extrabold leading-none text-blue-800">
              &ldquo;
            </div>
            <div className="mt-6 space-y-4">
              <span className="block h-2 w-full rounded-full bg-blue-100" />
              <span className="block h-2 w-full rounded-full bg-blue-100" />
              <span className="block h-2 w-4/5 rounded-full bg-blue-100" />
              <span className="block h-2 w-[92%] rounded-full bg-blue-100" />
              <span className="block h-2 w-2/5 rounded-full bg-blue-100" />
            </div>
            <span className="mt-9 block h-2.5 w-24 rounded-full bg-gradient-to-br from-blue-800 to-blue-800" />
          </div>
          <span className="absolute bottom-[26%] right-[13%] flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-blue-800 to-blue-800 text-white shadow-[0_22px_50px_rgba(30,64,175,0.3)] sm:h-24 sm:w-24">
