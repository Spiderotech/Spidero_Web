    ...
    <section className="overflow-hidden bg-white px-5 py-10 font-sans sm:px-8 lg:px-10 lg:py-12">
      <div className="mx-auto grid max-w-[1280px] items-center gap-8 lg:grid-cols-[minmax(0,0.86fr)_minmax(440px,1.14fr)] xl:gap-10">
        <div className="min-w-0">
          <div className="inline-flex items-center gap-2 rounded-xl bg-indigo-50 px-3.5 py-2 text-xs font-extrabold uppercase tracking-normal text-indigo-600 shadow-[0_16px_45px_rgba(79,70,229,0.08)]">
          ...
          <h2 className="mt-6 max-w-[520px] text-3xl font-extrabold leading-tight tracking-normal text-[#07122f] sm:text-4xl lg:text-[46px]">
            Emphasis On{" "}
            <span className="text-indigo-600">Mobile First</span> Web Design
          </h2>

          <div className="mt-4 flex items-center gap-3">
            <span className="h-0.5 w-9 rounded-full bg-indigo-600" />
            <span className="h-0.5 w-5 rounded-full bg-indigo-200" />
          </div>
          ...
          <div className="mt-7 flex flex-col gap-4 sm:flex-row sm:items-center">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-indigo-600 shadow-[0_16px_40px_rgba(79,70,229,0.1)] sm:h-14 sm:w-14">
              <SparklesIcon className="h-7 w-7" />
            </span>
            <div>
              <h3 className="text-xl font-extrabold uppercase tracking-normal text-indigo-600">
                Convinced?
              </h3>
          ...
          <a
            href="/contact"
            className="mt-6 inline-flex h-12 min-w-[260px] items-center justify-center gap-4 rounded-lg bg-gradient-to-r from-violet-600 to-blue-500 px-7 text-xs font-extrabold uppercase tracking-normal text-white shadow-[0_18px_42px_rgba(79,70,229,0.24)] transition hover:-translate-y-1"
          >
        ...
        <div className="relative min-h-[380px] overflow-hidden rounded-[28px] bg-indigo-50 shadow-[0_22px_65px_rgba(79,70,229,0.11)] sm:min-h-[500px] lg:min-h-[640px]">
          <img
            src={img1}
