  ...
  return (
    <section className="h-auto flex flex-col text-white py-0 px-3 bg-white">
      <div className="flex flex-col w-full h-auto text-center pt-40 mb-10">
        ...
        <div className="relative w-full md:w-[80%] h-[600px]">
          <img src={img} alt="" className="w-full h-[600px] object-cover" />
          <div className="  md:absolute  w-full md:w-[40%] mt-10 h-auto  md:h-[400px] top-28 left-40 right-0 bottom-0 flex flex-col justify-center items-center bg-white text-black ">
